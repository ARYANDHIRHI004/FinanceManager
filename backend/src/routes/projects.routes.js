...
projectRouter
  ...
  .post(addMemberToProject); // middlewares - verifyJW, subscription-premium, account-type, account-admin or collaborater, project-admin

projectRouter
  .route("/remove-members-from-project/:projectId")
  .delete(removeMemberFromProject); // middlewares - verifyJW, subscription-premium, account-type, account-admin or collaborater, project-admin

projectRouter
  .route("/get-all-project-members/:projectId")
  .get(getAllProjectMembers); // middlewares - verifyJW, subscription-premium, account-type, account-admin or collaborater, project-admin

projectRouter
  .route("/update-role-of-project-members/:projectId")
  .get(updateRoleOfProjectMembers); // middlewares - verifyJW, subscription-premium, account-type, account-admin or collaborater, project-admin
