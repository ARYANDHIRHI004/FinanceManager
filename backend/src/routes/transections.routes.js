...
import {
  ...
  getAllProjectTransection,
} from "../controllers/transection.controllers.js";
...
transectionRouter
  .route("/create-transection/:accountId")
  .post(
    verifyJWT,
...
transectionRouter
  .route("/get-all-project-transection/:accountId/project/:projectId")
  .get(verifyJWT, checkSubscription([""]), getAllProjectTransection); // verifyJWT, account-admin or collaborater, subscription - free and paid
...
transectionRouter
  .route("/delete-transection/:transectionId")
  .delete(verifyJWT, checkSubscription([""]), deleteTransection); // verifyJWT, account-admin or collaborater, subscription - free and paid
